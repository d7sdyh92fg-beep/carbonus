...
-- Only allow users to view their own reservations by matching customer email
...
-- Keep the insert policies but ensure they only allow authenticated users
-- to create records with their own email
