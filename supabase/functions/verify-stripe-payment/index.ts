  ...
  try {
    ...
    if (isCompleted && session.payment_intent) {
      ...
      if (reservation) {
        ...
        if (customer) {
          // NOTE: Contract PDF is generated by `generate-contract-pdf` function
          // when the customer signs at pickup. Do NOT generate a stub contract
          // here — it produced a short, duplicate version that confused clients.
          // contractPdfUrl stays null until signing.
