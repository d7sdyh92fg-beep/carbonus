export const translations = {
  ...
  faq: {
    ...
    review: {
      ...
      payAtCounterLater: "Automobilio atsiėmimo metu mokėsite: {amount} € (likusi nuomos suma + užstatas).",
      processing: "Vykdoma...",
  ...
  en: {
    ...
    review: {
      ...
      payAtCounterLater: "Upon vehicle pickup, you will pay: €{amount} (remaining rental amount + deposit).",
      processing: "Processing...",
