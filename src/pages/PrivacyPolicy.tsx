                ...
                <div className="space-y-8">
                  <div>
                    <div className="flex items-center gap-3 mb-4">
                      <Shield className="w-6 h-6 text-primary mt-2" />
                  ...
                  <div>
                    <div className="flex items-center gap-3 mb-4">
                      <Phone className="w-6 h-6 text-primary mt-2" />
                  ...
                  <div>
                    <div className="flex items-center gap-3 mb-4">
                      <Calendar className="w-6 h-6 text-primary mt-2" />
                  ...
                  <div>
                    <div className="flex items-center gap-3 mb-4">
                      <MapPin className="w-6 h-6 text-primary mt-2" />
