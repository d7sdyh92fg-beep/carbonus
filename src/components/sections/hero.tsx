...
export function Hero({ carImage }: HeroProps) {
  ...
  return (
    <section className="relative min-h-[60vh] md:min-h-screen pt-10 md:pt-16 flex items-start md:items-center overflow-hidden bg-transparent md:bg-gradient-to-br md:from-gray-50 md:to-white">
