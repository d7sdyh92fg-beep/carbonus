...
export function Hero({ carImage }: HeroProps) {
  ...
  return (
    <section className="relative min-h-screen pt-4 md:pt-16 flex items-center overflow-hidden bg-transparent md:bg-gradient-to-br md:from-gray-50 md:to-white">
