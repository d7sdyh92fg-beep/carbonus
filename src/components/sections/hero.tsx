  ...
  return (
    <section className="relative bg-[hsl(220_27%_8%)] text-white h-[100svh] flex flex-col overflow-hidden">
      ...
      <div className="relative flex-1 flex flex-col overflow-hidden">
        ...
        <div aria-hidden className="absolute inset-0 bg-gradient-to-b from-[hsl(220_27%_8%)]/95 via-[hsl(220_27%_8%)]/70 to-[hsl(220_27%_8%)]/98" />
        <div aria-hidden className="absolute inset-0 bg-gradient-to-r from-[hsl(220_27%_8%)]/90 via-transparent to-[hsl(220_27%_8%)]/70" />
        <div aria-hidden className="absolute inset-0 bg-[radial-gradient(circle_at_center,transparent_25%,hsl(220_27%_8%)/92_100%)]" />
