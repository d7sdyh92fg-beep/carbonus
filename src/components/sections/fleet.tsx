                  ...
                  <img
                    ...
                    className={`w-full h-48 transition-transform duration-300 ${
                      car.name === "Volkswagen Passat" 
                        ? "object-contain object-center scale-[1.15] md:scale-[2.5] lg:scale-[1.3] -translate-y-2 group-hover:scale-[1.2] md:group-hover:scale-[2.6] lg:group-hover:scale-[1.36]" 
