...
const GALLERY = [
  ...
  { src: slkInterior, lt: "Mercedes-Benz SLK salonas", en: "Mercedes-Benz SLK interior", cover: true, imageClass: "" },
];
...
export function SlkDetailPage({ pricing, selectedPackage, onSelectedPackageChange }: SlkDetailPageProps) {
  ...
  const copy = isEnglish
    ? {
        premium: "Premium convertible",
        title: "Mercedes-Benz SLK",
        subtitle: "Open-roof freedom for special moments and memorable journeys.",
        description:
          "A compact two-seat roadster that combines expressive design, automatic transmission and true open-air driving pleasure. A distinctive choice for a romantic escape, celebration or weekend trip.",
        ...
        bookingTitle: "Reserve your Mercedes-Benz SLK",
    ...
    : {
        premium: "Premium kabrioletas",
        title: "Mercedes-Benz SLK",
        subtitle: "Laisvė po atviru dangumi ypatingoms progoms ir įsimintinoms kelionėms.",
        description:
          "Kompaktiškas dvivietis rodsteris, kuriame dera išraiškingas dizainas, automatinė pavarų dėžė ir tikras vairavimo po atviru dangumi malonumas. Išskirtinis pasirinkimas romantiškam pabėgimui, šventei ar savaitgalio kelionei.",
        ...
        bookingTitle: "Rezervuokite Mercedes-Benz SLK",
  ...
  const features = Array.from({ length: 8 }, (_, index) => t(`carData.6.feature${index + 1}`));
  const featureGroups = [
  ...
  return (
    <div className="min-h-screen overflow-x-hidden bg-white font-sans text-foreground">
      <SEOHead
        ...
        canonical={`https://carbonus.lt/${isEnglish ? "cars/mercedes-benz-slk-rental" : "automobiliai/mercedes-benz-slk-nuoma"}`}
        ogImage={slkFront}
        ogType="product"
        ...
        <section className="bg-[hsl(210_20%_96%)] pb-10 pt-7 sm:pb-12 sm:pt-9">
          <div className="mx-auto max-w-[1320px] px-5 sm:px-6">
            <nav className="flex flex-wrap items-center gap-2 text-[13px] font-semibold uppercase tracking-[0.07em] text-foreground/60" aria-label="Breadcrumb">
              ...
              <span>/</span>
              <span className="text-[hsl(var(--carbonus-green-dark))]">Mercedes-Benz SLK</span>
            </nav>
            ...
            <div className="mt-7 grid gap-8 lg:grid-cols-[minmax(0,1.14fr)_minmax(430px,0.86fr)] lg:items-start lg:gap-8">
              <div>
                ...
                <div className="mt-5 grid grid-cols-3 gap-4">
                  {GALLERY.map((image, index) => (
                    ...
                    >
                      <img src={image.src} alt="" width={320} height={220} loading="lazy" decoding="async" className={`h-full w-full ${image.cover ? "object-cover" : "object-contain p-1 sm:scale-[1.45]"}`} />
              ...
              <aside className="rounded-[28px] border border-border/70 bg-white p-7 shadow-[0_22px_55px_rgba(15,23,42,0.08)] sm:p-9 lg:sticky lg:top-[98px]">
                <div className="flex flex-wrap items-center gap-2 text-[12px] font-bold uppercase tracking-[0.07em] text-amber-700">
                  ...
                  <span className="text-[hsl(var(--carbonus-green-dark))]">2015</span>
                </div>
                ...
                <div className="mt-6 grid grid-cols-3 gap-2">
                  {[
                    { Icon: Users, value: "2", label: copy.passengers },
            ...
            <div className="mt-20 grid gap-7 sm:mt-24 lg:grid-cols-[0.82fr_1.18fr] lg:items-start">
              <div className="order-last lg:order-first">
                <p className="text-[11px] font-bold uppercase tracking-[0.18em] text-[hsl(var(--carbonus-green-dark))]">Mercedes-Benz SLK</p>
              ...
              <div className="order-first aspect-[16/10] w-full overflow-hidden rounded-[24px] bg-[#eee7dc] shadow-[0_18px_45px_rgba(15,23,42,0.12)] lg:order-last">
                <img src={slkScenic} alt={isEnglish ? "Mercedes-Benz SLK scenic drive" : "Mercedes-Benz SLK kelionėje"} width={1024} height={1024} loading="lazy" decoding="async" className="h-full w-full object-cover object-[center_60%]" />
              </div>
            </div>
          </div>
        </section>
