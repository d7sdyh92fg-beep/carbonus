              ...
              <div>
                ...
                <div className="mt-5 grid grid-cols-3 gap-3 sm:gap-4">
                  {gallery.map((image, index) => (
                    ...
                    >
                      <img src={image} alt="" width={420} height={260} loading="lazy" decoding="async" className={`h-full w-full ${index === 2 ? "object-cover" : (car.id === "3" || car.id === "4" ? "object-contain p-1 sm:scale-[1.15]" : "object-contain p-1 sm:scale-[1.45]")}`} />
