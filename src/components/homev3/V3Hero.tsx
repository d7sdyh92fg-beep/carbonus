      ...
      <div className="relative mx-auto max-w-[1320px] px-6 pb-10 lg:min-h-[clamp(480px,40vw,640px)] lg:pb-12">
        <div className="grid gap-8 sm:gap-10 lg:h-[clamp(480px,39.5vw,620px)] lg:grid-cols-[minmax(0,0.9fr)_minmax(0,1.1fr)] lg:items-start">
          ...
          <div className="relative">
            ...
            <div className="pointer-events-none absolute left-0 top-[55%] w-full max-w-none -translate-y-1/2 scale-[1.11] sm:top-[56%] md:top-[58%] lg:left-[-13%] lg:top-[62%] lg:w-[126%] lg:-translate-y-[64%] lg:scale-[1.07] xl:left-[-20%] xl:top-[58%] xl:w-[138%] xl:-translate-y-[66%] xl:scale-[1.02]">
              <span
                aria-hidden="true"
        ...
        <div className="relative z-20 mt-4 w-full pb-8 sm:mt-6 lg:absolute lg:bottom-[-22px] lg:left-6 lg:mt-0 lg:w-[clamp(640px,54vw,850px)] lg:pb-0">
          <V3SearchBar />
          <a
