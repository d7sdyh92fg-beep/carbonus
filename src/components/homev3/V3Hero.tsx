      ...
      <div className="relative mx-auto max-w-[1320px] px-6 pb-10 lg:min-h-[clamp(480px,40vw,640px)] lg:pb-12">
        <div className="grid gap-8 sm:gap-10 lg:h-[clamp(480px,39.5vw,620px)] lg:grid-cols-[minmax(0,0.95fr)_minmax(0,1.0fr)] lg:items-start">
          ...
          <div className="relative overflow-hidden">
            ...
            <div className="pointer-events-none absolute left-0 top-1/2 w-full max-w-none -translate-y-1/2 scale-[14.85] lg:left-[-5%] lg:w-[110%] lg:-translate-y-[56%] lg:scale-[14.80] xl:left-[-10%] xl:w-[120%] xl:-translate-y-[58%] xl:scale-[14.76]">
              <span
                aria-hidden="true"
