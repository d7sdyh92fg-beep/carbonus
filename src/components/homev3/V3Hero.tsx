    ...
    <section className="relative bg-white pt-[92px] sm:pt-[100px] lg:pt-[72px]">
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div className="pointer-events-none absolute inset-0">
          ...
          <div className="animate-hero-overlay-sweep-bottom absolute inset-x-0 bottom-0 h-2/3 bg-gradient-to-t from-white via-white/75 via-[30%] to-transparent to-[65%] sm:h-[70%] sm:via-white/80 sm:via-[30%] sm:to-white/30 sm:to-[75%]" />
        </div>
      </div>
