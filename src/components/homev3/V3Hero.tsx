...
export function V3Hero() {
  ...
  return (
    <section className="bg-white pt-[92px] sm:pt-[100px] lg:pt-[72px]">
      <div className="relative mx-auto max-w-[1320px] overflow-hidden">
        <div className="absolute inset-0">
          <img
            src={heroAsset.url}
            alt={c.imageAlt}
            className="h-full w-full object-cover object-[70%_-20%] sm:object-[62%_5%] lg:object-center"
          />
          ...
          <div className="pointer-events-none absolute inset-0">
            ...
            {/* Bottom edge cover to hide the photo seam on tablet */}
            <div className="absolute inset-x-0 bottom-0 hidden h-2 bg-white sm:block" />
          </div>
        </div>

        <div className="relative px-5 pb-8 sm:px-6 lg:pb-14">
