  ...
  return (
    <section className="relative bg-white pt-[96px] sm:pt-[104px] lg:pt-[78px]">
      ...
      <div className="relative mx-auto max-w-[1320px] px-6 pb-10 lg:min-h-[clamp(480px,40vw,640px)] lg:pb-12">
        ...
        <div className="relative z-20 mt-4 w-full pb-8 sm:mt-6 lg:absolute lg:bottom-[clamp(48px,4.4vw,66px)] lg:left-6 lg:mt-0 lg:w-[clamp(640px,54vw,850px)] lg:pb-0">
          <V3SearchBar />
          <a
